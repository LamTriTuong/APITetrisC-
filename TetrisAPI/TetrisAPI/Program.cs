...
{
    sConnection = "Server=localhost;Database=Tetris;User Id=sincollmm;Password=zxcZXCV123";
}
...
{
    httpClient.BaseAddress = new Uri("https://localhost:5555/index.html");
    httpClient.DefaultRequestHeaders.Add(
        HeaderNames.UserAgent, "https://localhost:5555/index.html");
});
